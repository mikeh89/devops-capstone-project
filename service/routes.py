...
def get_accounts():
    ...
    app.logger.info("[%s] Accounts returned", len(account_list))
...
def read_account(id):
    ...
    app.logger.info("Returning account with ID: %s", id)
...
def delete_account(id):
    """
    Delete an Account
    This endpoint will Delete an existing Account based on id
    """
